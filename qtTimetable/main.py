...
class MainWindow(QWidget):
    def __init__(self):
        self.time = ['9:30', '11:20', '13:10', '15:25', '17:15', '19:00', '20:40', '22:10']
    ...
    def _create_shedule_tab(self):
        ...
        self.shboxes = [QVBoxLayout() for _ in range(2)]
    ...
    def _update_table(self, table, weekday):
        ...
        for i, r in enumerate(records):
            if str(r[1]) not in empty:
                ...
                table.setItem(i, 1, QTableWidgetItem(str(self.time[i])))
        ...
        table.setItem(i + 1, 1, QTableWidgetItem(str(self.time[i + 1])))
